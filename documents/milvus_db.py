...
from pymilvus import IndexType, MilvusClient, Function, connections
...
class MilvusVectorSave:
    ...
    def create_collection(self):
        ...
        index_params.add_index(
            ...
            metric_type="BM25",
            params={
                "inverted_index_algo": "DAAT_MAXSCORE",                                                  # 倒排索引
    ...
    def create_connection(self):
        ...
        # 显式建立默认别名，避免连接别名不一致导致查询时报 ConnectFirst
        ...
        self.vector_store_saved = Milvus(
            ...
            auto_id=True,
            connection_args={"uri": MILVUS_URI, "alias": "default"}
        )
